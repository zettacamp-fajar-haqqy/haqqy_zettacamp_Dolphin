...
const { bookList, loadingMessage, shoppingList, generateMonthlyBill, verifyToken, getNextSequenceValue, addBook } = require('../helper/helpers')
...
router.post('/add-book', async(req, res) => {
    try {
        ...
        const newBook = new Book({
            _id: await getNextSequenceValue('bookId'),
            title,
            price,
            genre,
            author,
